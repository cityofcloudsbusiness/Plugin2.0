                ...
                <div class="inferior">
                    <ul>
                        ...
                        foreach ($menu as $items): ?>
                            <li class="flex flex-row font-sans text-white justify-start items-center <?= $i === 0 ? 'active' : ''; ?> menu-item">
                                <i style="margin-right: 15px;"><?= $items['icon']; ?></i>
                                <a href="<?= $items['route'] ?>" onclick="loadPage('<?= $items['route'] ?>', this, this.dataset.titulo); return false;" data-titulo="<?= $items['titulo'] ?>"><?= $items['label']; ?></a>
                            </li>
                        <?php $i++;
                        endforeach; ?>
                    </ul>
